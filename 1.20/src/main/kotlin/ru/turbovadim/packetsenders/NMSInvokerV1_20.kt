...
class NMSInvokerV1_20 : NMSInvoker() {
    ...
    override fun sendPhasingGamemodeUpdate(player: Player, gameMode: GameMode) {
        ...
        val packet: ClientboundPlayerInfoUpdatePacket = OriginsRebornClientboundPlayerInfoUpdatePacket(
    ...
    class OriginsRebornClientboundPlayerInfoUpdatePacket(actions: EnumSet<Action?>, entry: Entry?) :
